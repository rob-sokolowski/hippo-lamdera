module Evergreen.V30.Auth.Common exposing (..)

import Evergreen.V30.OAuth
import Evergreen.V30.OAuth.AuthorizationCode
import Time
import Url
...
type Error
    = ErrStateMismatch
    | ErrAuthorization Evergreen.V30.OAuth.AuthorizationCode.AuthorizationError
    | ErrAuthentication Evergreen.V30.OAuth.AuthorizationCode.AuthenticationError
...
type Flow
    ...
    | Authenticated Evergreen.V30.OAuth.Token
    | Done UserInfo
    | Errored Error
...
type alias Token =
    { methodId : MethodId
    , token : Evergreen.V30.OAuth.Token
    , created : Time.Posix
    , expires : Time.Posix
    }
