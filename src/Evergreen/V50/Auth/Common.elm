module Evergreen.V50.Auth.Common exposing (..)
...
type Error
    = ErrStateMismatch
    | ErrAuthorization Evergreen.V50.OAuth.AuthorizationCode.AuthorizationError
    | ErrAuthentication Evergreen.V50.OAuth.AuthorizationCode.AuthenticationError
...
type Flow
    ...
    | Authenticated Evergreen.V50.OAuth.Token
    | Done UserInfo
    | Errored Error
...
type alias Token =
    { methodId : MethodId
    , token : Evergreen.V50.OAuth.Token
    , created : Time.Posix
    , expires : Time.Posix
    }
