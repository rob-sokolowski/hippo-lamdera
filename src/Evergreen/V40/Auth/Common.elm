module Evergreen.V40.Auth.Common exposing (..)

import Evergreen.V40.OAuth
import Evergreen.V40.OAuth.AuthorizationCode
import Time
import Url
...
type Error
    = ErrStateMismatch
    | ErrAuthorization Evergreen.V40.OAuth.AuthorizationCode.AuthorizationError
    | ErrAuthentication Evergreen.V40.OAuth.AuthorizationCode.AuthenticationError
...
type Flow
    ...
    | Authenticated Evergreen.V40.OAuth.Token
    | Done UserInfo
    | Errored Error
...
type alias Token =
    { methodId : MethodId
    , token : Evergreen.V40.OAuth.Token
    , created : Time.Posix
    , expires : Time.Posix
    }
