module Evergreen.V28.Auth.Common exposing (..)

import Evergreen.V28.OAuth
import Evergreen.V28.OAuth.AuthorizationCode
import Time
import Url
...
type Error
    = ErrStateMismatch
    | ErrAuthorization Evergreen.V28.OAuth.AuthorizationCode.AuthorizationError
    | ErrAuthentication Evergreen.V28.OAuth.AuthorizationCode.AuthenticationError
...
type Flow
    ...
    | Authenticated Evergreen.V28.OAuth.Token
    | Done UserInfo
    | Errored Error
...
type alias Token =
    { methodId : MethodId
    , token : Evergreen.V28.OAuth.Token
    , created : Time.Posix
    , expires : Time.Posix
    }
