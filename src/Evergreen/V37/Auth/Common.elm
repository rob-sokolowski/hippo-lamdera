module Evergreen.V37.Auth.Common exposing (..)

import Evergreen.V37.OAuth
import Evergreen.V37.OAuth.AuthorizationCode
import Time
import Url
...
type Error
    = ErrStateMismatch
    | ErrAuthorization Evergreen.V37.OAuth.AuthorizationCode.AuthorizationError
    | ErrAuthentication Evergreen.V37.OAuth.AuthorizationCode.AuthenticationError
...
type Flow
    ...
    | Authenticated Evergreen.V37.OAuth.Token
    | Done UserInfo
    | Errored Error
...
type alias Token =
    { methodId : MethodId
    , token : Evergreen.V37.OAuth.Token
    , created : Time.Posix
    , expires : Time.Posix
    }
