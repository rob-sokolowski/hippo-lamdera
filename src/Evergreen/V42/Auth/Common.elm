module Evergreen.V42.Auth.Common exposing (..)

import Evergreen.V42.OAuth
import Evergreen.V42.OAuth.AuthorizationCode
import Time
import Url
...
type Error
    = ErrStateMismatch
    | ErrAuthorization Evergreen.V42.OAuth.AuthorizationCode.AuthorizationError
    | ErrAuthentication Evergreen.V42.OAuth.AuthorizationCode.AuthenticationError
...
type Flow
    ...
    | Authenticated Evergreen.V42.OAuth.Token
    | Done UserInfo
    | Errored Error
...
type alias Token =
    { methodId : MethodId
    , token : Evergreen.V42.OAuth.Token
    , created : Time.Posix
    , expires : Time.Posix
    }
