module Evergreen.V26.Auth.Common exposing (..)

import Evergreen.V26.OAuth
import Evergreen.V26.OAuth.AuthorizationCode
import Time
import Url
...
type Error
    = ErrStateMismatch
    | ErrAuthorization Evergreen.V26.OAuth.AuthorizationCode.AuthorizationError
    | ErrAuthentication Evergreen.V26.OAuth.AuthorizationCode.AuthenticationError
...
type Flow
    ...
    | Authenticated Evergreen.V26.OAuth.Token
    | Done UserInfo
    | Errored Error
...
type alias Token =
    { methodId : MethodId
    , token : Evergreen.V26.OAuth.Token
    , created : Time.Posix
    , expires : Time.Posix
    }
