...
import Dict
import Evergreen.V39.Api.Card as OldCard exposing (CardEnvelope, FlashCard(..))
import Evergreen.V39.Api.User
import Evergreen.V39.Types as Old
import Evergreen.V40.Api.Card as NewCard exposing (FlashCard(..))
...
backendModel old =
    let
        ...
        migrateUser : Evergreen.V39.Api.User.UserFull -> Evergreen.V40.Api.User.UserFull
        migrateUser old_ =
            { id = old_.id
            , email = old_.email
            ...
            , card =
                case old_.card of
                    ...
                    OldCard.Markdown card ->
                        NewCard.Markdown { question = card.question, answer = card.answer, tag = Nothing }
            , userId = old_.userId
