module Evergreen.V39.Auth.Common exposing (..)

import Evergreen.V39.OAuth
import Evergreen.V39.OAuth.AuthorizationCode
import Time
import Url
...
type Error
    = ErrStateMismatch
    | ErrAuthorization Evergreen.V39.OAuth.AuthorizationCode.AuthorizationError
    | ErrAuthentication Evergreen.V39.OAuth.AuthorizationCode.AuthenticationError
...
type Flow
    ...
    | Authenticated Evergreen.V39.OAuth.Token
    | Done UserInfo
    | Errored Error
...
type alias Token =
    { methodId : MethodId
    , token : Evergreen.V39.OAuth.Token
    , created : Time.Posix
    , expires : Time.Posix
    }
