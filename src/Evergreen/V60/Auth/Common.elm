module Evergreen.V60.Auth.Common exposing (..)

import Evergreen.V60.OAuth
import Evergreen.V60.OAuth.AuthorizationCode
import Time
import Url
...
type Error
    = ErrStateMismatch
    | ErrAuthorization Evergreen.V60.OAuth.AuthorizationCode.AuthorizationError
    | ErrAuthentication Evergreen.V60.OAuth.AuthorizationCode.AuthenticationError
...
type Flow
    ...
    | Authenticated Evergreen.V60.OAuth.Token
    | Done UserInfo
    | Errored Error
...
type alias Token =
    { methodId : MethodId
    , token : Evergreen.V60.OAuth.Token
    , created : Time.Posix
    , expires : Time.Posix
    }
