module Evergreen.V54.Auth.Common exposing (..)
...
type Error
    = ErrStateMismatch
    | ErrAuthorization Evergreen.V54.OAuth.AuthorizationCode.AuthorizationError
    | ErrAuthentication Evergreen.V54.OAuth.AuthorizationCode.AuthenticationError
...
type Flow
    ...
    | Authenticated Evergreen.V54.OAuth.Token
    | Done UserInfo
    | Errored Error
...
type alias Token =
    { methodId : MethodId
    , token : Evergreen.V54.OAuth.Token
    , created : Time.Posix
    , expires : Time.Posix
    }
