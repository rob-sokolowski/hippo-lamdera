module Evergreen.V25.Auth.Common exposing (..)

import Evergreen.V25.OAuth
import Evergreen.V25.OAuth.AuthorizationCode
import Time
import Url
...
type Error
    = ErrStateMismatch
    | ErrAuthorization Evergreen.V25.OAuth.AuthorizationCode.AuthorizationError
    | ErrAuthentication Evergreen.V25.OAuth.AuthorizationCode.AuthenticationError
...
type Flow
    ...
    | Authenticated Evergreen.V25.OAuth.Token
    | Done UserInfo
    | Errored Error
...
type alias Token =
    { methodId : MethodId
    , token : Evergreen.V25.OAuth.Token
    , created : Time.Posix
    , expires : Time.Posix
    }
