module Evergreen.V53.Auth.Common exposing (..)
...
type Error
    = ErrStateMismatch
    | ErrAuthorization Evergreen.V53.OAuth.AuthorizationCode.AuthorizationError
    | ErrAuthentication Evergreen.V53.OAuth.AuthorizationCode.AuthenticationError
...
type Flow
    ...
    | Authenticated Evergreen.V53.OAuth.Token
    | Done UserInfo
    | Errored Error
...
type alias Token =
    { methodId : MethodId
    , token : Evergreen.V53.OAuth.Token
    , created : Time.Posix
    , expires : Time.Posix
    }
